...
function StereoAudioRecorderHelper(mediaStream, root) {
    ...
    // variables    
    var deviceSampleRate = 48000; // range: 22050 to 96000
 ...
 //     root.ondataavailable(blob);
    ...
    function mergeBuffers(channelBuffer, recordingLength) {
        var result = new Float64Array(recordingLength);
        var offset = 0;
    ...
    var bufferSize = root.bufferSize || 1024 ;
...
//     	leftchannel[0] = new Float32Array(left);
