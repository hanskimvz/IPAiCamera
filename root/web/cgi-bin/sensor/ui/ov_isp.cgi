...
<div id="Day_Night_Settings">
	<div>
		<table>
			...
			<tr class="whiteled_mode">
        		<td style="width:172px;"><label class="subtitle"><span tkey="setup_whiteled"></span></label></td>
        		<td>
          			<input id="ir_led" name="wlmode" type="radio" value=0>
          			<label for="ir_led"></label><span tkey="off" ></span>
          			<input id="white_led" name="wlmode" type="radio" value=1>
          			<label for="white_led"></label><span tkey="on" ></span>
        		</td>
      		</tr>
			<tr class="ir_mode">
        		<td style="width:172px;"><label class="subtitle"><span tkey="setup_ir_led_enable">IR Mode</span></label></td>
        		<td>
          			<input id="ir_enable" name="irmode" type="radio" value=0>
          			<label for="ir_enable"></label><span tkey="setup_enable" ></span>
          			<input id="ir_disable" name="irmode" type="radio" value=1>
          			<label for="ir_disable"></label><span tkey="setup_disable" ></span>
        		</td>
      		</tr>
<!--					
			<tr>
