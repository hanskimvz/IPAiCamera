...
<div id="Backlight_Switch">
	<div>
		<table>
			...
			-->
			<tr>
				<td><label class="subtitle width140" tkey="setup_av_hdr">HDR Mode</label></td>
				<td>
					<div class="select">
						<select name="hdr" id="hdr" class='radius'>
							<option value='0'>Off</option>
							<option value='1'>HDR X3</option>
							<!--
			...
			<tr>
				<td><label class="subtitle width140" tkey="setup_av_hdr_level"></label></td>
				<td>
					<div class="select">
