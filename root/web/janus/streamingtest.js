...
var janus = null;
var streaming = null;
var opaqueId = "streaming_ipnc-"+Janus.randomString(12);
			...
			janus = new Janus(
				{
					...
					success: function() {
						...
						janus.attach(
							{
								plugin: "janus.plugin.cprostreaming",
								opaqueId: opaqueId,
								...
								onremotestream: function(stream) {
									...
									if($('#remotevideo').length === 0) {
										addButtons = true;
                                        $('#stream').append('<video class="centered hide" id="remotevideo" width="960px" height="540px" autoplay muted playsinline/>');
...
//            $('#streamslist a').unbind('click').click(function() {
                selectedStream = 98;//$(this).attr("id");
...
function startStream() {
	...
	// No remote video yet
    $('#stream').append('<video class="centered hide" id="waitingvideo" width=960px height=540px />');
	if(spinner == null) {
